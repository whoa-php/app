 ...
 * @package Tests
 */
class OAuthScopeApiTest extends TestCase
{
    ...
    public function testIndexWithParameter()
    {
        ...
        $identifier = PassportSeed::SCOPE_IDENTIFIER_ADMIN_OAUTH;
        ...
        $queryParams = [
            ...
            'sort' => '+id,uuid,oauth-clients,oauth-clients.id',
            // example of how multiple sorting conditions could be applied
            'include' => 'oauth-clients',
            'fields' => [
                'oauth-scopes' => 'id,uuid,identifier,oauth-clients',
            ],
        ];
        ...
        $this->assertEquals($identifier, $resource->attributes->identifier);
        $this->assertEquals(1, $resource->relationships->{'oauth-clients'}->data[0]->id);
